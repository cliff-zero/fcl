...
{ //
  ...
  {
    static PselPropCache cache("PselPropCache", 1024, 4);
    return cache;
  }

  inline PselPropCache &get_psel_prop_smear_cache()
  {
    static PselPropCache cache("PselPropSmearCache", 2048, 4);
    return cache;
  }

  inline SelPropCache &get_prop_psrc_cache()
  {
    static SelPropCache cache("PropPsrcCache", 512, 2);
    return cache;
  }

  inline SelPropCache &get_prop_smear_cache()
  {
    static SelPropCache cache("PropSmearCache", 512, 2);
    return cache;
  }
  ...
  inline const PointSelection &get_point_selection_smear(const std::string &job_tag,
                                                         const int traj)
  {
