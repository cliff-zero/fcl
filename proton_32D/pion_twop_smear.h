...
#pragma omp for
    ...
    inline std::string get_pion_two_point_smear_path(const std::string &job_tag,
                                                     const int traj)
    {
        return ssprintf("analysis/pion_twop_smear/%s/results=%d", job_tag.c_str(),
                        traj);
    }
    ...
    inline void compute_pion_two_point_smear_func(const std::string &job_tag, const int traj)
    {
        ...
        setup(job_tag, traj);
        qmkdir_info("analysis/pion_twop_smear");
        qmkdir_info(ssprintf("analysis/pion_twop_smear/%s", job_tag.c_str()));
        qmkdir_info(path);
