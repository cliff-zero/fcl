...
#pragma omp parallel for
                                                              ...
                                                              const std::vector<int> &tsep_list)
    {
        ...
        contract_proton_twop_block(block, psel_num_list, psel_dt_num_list, job_tag, traj, geo, psel, dtmax, dtmin, coef_fourp);
                                                                 ...
                                                                 const int traj)
    {
        ...
        if (does_file_exist_sync_node(path + "/fourp-data-dt3-disconnected.field"))
        {
            return;
        }
